                    ...
                    <div class="layout-specing">
                        <div class="md:flex justify-between items-center">
                            ...
                            <ul class="tracking-[0.5px] inline-block sm:mt-0 mt-3">
                                ...
                                <li class="inline-block capitalize text-[14px] font-bold duration-500 dark:text-white/70 hover:text-indigo-600 dark:hover:text-white"><router-link to="/shop">Shop</router-link></li>
                                <li class="inline-block text-base text-slate-950 dark:text-white/70 mx-0.5 ltr:rotate-0 rtl:rotate-180"><i class="uil uil-angle-right-b"></i></li>
                                ...
                                <div class="p-6 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                                    ...
                                    <div class="subcribe-form mt-6">
                                        <form class="relative max-w-xl">
                                            <input type="email" id="subcribe" name="email" class="py-4 pe-40 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700" placeholder="Promo code">
