                    ...
                    <ul class="sidebar-menu border-t border-white/10" data-simplebar style="height: calc(100% - 70px);">
                        ...
                        <li class="relative lg:m-8 m-6 px-8 py-10 rounded-lg bg-gradient-to-b to-transparent from-indigo-700 text-center">
                                <span class="relative z-10">
                                        ...
                                        <a href="https://shreethemes.in" target="_blank" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-700/50 hover:bg-indigo-700 border-indigo-700/50 hover:border-indigo-700 text-white rounded-md">Subscribe</a>
                                </span>
